...
select customer_id, age, income, tenure, loan_type, loan_amount, occupation, number_of_current_accounts, max_cc_spent_amount, mode_job_of_contacts from credit_scoring_100k_v where rownum &lt;< 1000</copy>
```
