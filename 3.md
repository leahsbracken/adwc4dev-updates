...
## **Step 3:** Log into ***ATP*** SQL Developer Web and create user ml\_user and grant that user privileges to create tables and and access SQL Developer Web.
...
- Create a credential to copy your ADW wallet from Object Storage to the DATA\_PUMP\_DIR later in this step.  This is your cloud userid and generated auth token.
```
BEGIN
