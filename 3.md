...
storage, and created an auth\_token. Copy the wallet downloaded from Lab 1 to the directory data\_pump\_dir by entering the following into SQL Developer Web.
...
```
<copy>
create user ml_user identified by WelCome1234_; -- THIS SHOULD BE DONE IN LAB 1
grant dwrole, oml_developer to ml_user; -- THIS SHOULD BE DONE IN LAB 1
create table temp(my_model blob);
